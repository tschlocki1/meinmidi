...
private let log = Logger(subsystem: "TimSchlockermann.MidiQuestionExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<MidiQuestionExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try MidiQuestionExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? MidiQuestionExtensionAudioUnit else {
            log.error("Unable to create MidiQuestionExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(MidiQuestionExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = MidiQuestionExtensionMainView(parameterTree: observableParameterTree)
