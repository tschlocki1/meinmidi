//
//  MidiQuestionExtensionAUProcessHelper.hpp
...
#include <vector>
#include "MidiQuestionExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(MidiQuestionExtensionDSPKernel& kernel)
    : mKernel{kernel} {}
...
private:
    MidiQuestionExtensionDSPKernel& mKernel;
};
